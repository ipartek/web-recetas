...
public class UsuarioDAOTest {
	...
	public void testFilterByDni() {
		...
		Usuario uExito = dao.getByDNI("12345678L");
		Usuario uFracaso = dao.getByDNI("1");
		Usuario uNull = dao.getByDNI(null);
	...
	public void testComprobarIntegridad() {
		...
		/*ssertFalse(dao.comprobarIntegridad(DNI_EXISTE, EMAIL_EXISTE));
