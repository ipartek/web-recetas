...
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE,
		DispatcherType.ERROR }, asyncSupported = true, description = "filtro para comprobar todas las peticiones que accedan a la zona segura, deben estar logeado en session", urlPatterns = {
				"/zona-segura/*" })
