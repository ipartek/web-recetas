...
public class UsuarioCRUDController extends HttpServlet {
	...
	// vistas
	private static final String VIEW_LIST = "zona-segura/usuarios-bbdd/index.jsp";
	private static final String VIEW_FORM = "zona-segura/usuarios-bbdd/formulario.jsp";
