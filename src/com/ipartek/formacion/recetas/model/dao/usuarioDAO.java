...
public class usuarioDAO implements Persistable<Usuario> {
	...
	static final private String SQL_GET_ALL = "SELECT `id`,`nombre`,`apellido1`,`apellido2`,`edad`,`email`,`dni`,`puesto`,`password`,`imagen` FROM `usuario` ORDER BY 'id' LIMIT 500";
	...
	static final private String SQL_COUNT = "SELECT COUNT(*) FROM `usuario`;";
