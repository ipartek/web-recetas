	...
	<div class="row">
		...
		<form action="zona-segura/usuario" method="post">
			...
			<label class="radio-inline"><input type="radio"
				name="optradio" value="nombre" checked="checked">Nombre</label> <label
				class="radio-inline"><input type="radio" name="optradio"
				value="dni">Dni</label> <label class="radio-inline"><input
				type="radio" name="optradio" value="email">Email</label> <input
				type="text" name="filtro" class="form-control" id="filtro"
				required="required"><br /> <input type="submit"
				class="btn btn-info" value="Filtrar"> <input type="hidden"
				name="op" value="<%=UsuarioCRUDController.OP_FILTRAR%>">
		</form>
		<br/>
		<form action="zona-segura/usuario" method="post">
		<input type="submit" class="btn btn btn-danger" value="Eliminar Filtro"> <input
				type="hidden" name="op"
				value="<%=UsuarioCRUDController.OP_LISTAR%>">
		</form>
	</div>
	<hr>
	<p>LISTADO DE USUARIOS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-success" href="zona-segura/usuario?op=3">Crear
		Nuevo Usuario</a></p>
